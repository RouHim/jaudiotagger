...
public class FilePermissionsTest {
    ...
    public static void runWriteWriteProtectedFileWithCheckDisabled(String sourceFile) throws Exception {
        ...
        try {
            ...
            assertTrue(threwException, "Expected to throw " + NoWritePermissionsException.class.getSimpleName() + " but didn't");
        } finally {
            testFile.delete();
        }
    }
    ...
    public static void runWriteWriteProtectedFileWithCheckEnabled(String sourceFile) throws Exception {
        ...
        try {
            ...
            assertTrue(threwException, "Expected to throw " + CannotWriteException.class.getSimpleName() + " but didn't");
        } finally {
            testFile.delete();
        }
    }
