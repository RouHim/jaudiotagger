...
public final class MetadataDescriptorUtils {
   ...
   *
   * @param m1 descriptor to test
   * @param m2 descriptor to test
   * @return <code>true</code> if they represent the same.
   * @throws IllegalArgumentException if they are the same object (<code>m1 == m2</code>).
   */
  public static boolean equals(
    final MetadataDescriptor m1,
