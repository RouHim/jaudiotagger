...
public class AsfCodeCheckTest {
  ...
  public void testAsfTagImpl() throws Exception {
    ...
    assertEquals(
      asfTag.createField(FieldKey.ALBUM, "").getId(),
      AsfFieldKey.ALBUM.getFieldName()
    );
    assertEquals(
      asfTag.createField(FieldKey.ARTIST, "").getId(),
      AsfFieldKey.AUTHOR.getFieldName()
    );
    assertEquals(
      asfTag.createField(FieldKey.COMMENT, "").getId(),
      AsfFieldKey.DESCRIPTION.getFieldName()
    );
    assertEquals(
      asfTag.createField(FieldKey.GENRE, "").getId(),
      AsfFieldKey.GENRE.getFieldName()
    );
    assertEquals(
      asfTag.createField(FieldKey.TITLE, "").getId(),
      AsfFieldKey.TITLE.getFieldName()
    );
    assertEquals(
      asfTag.createField(FieldKey.TRACK, "").getId(),
      AsfFieldKey.TRACK.getFieldName()
    );
    assertEquals(
      asfTag.createField(FieldKey.YEAR, "").getId(),
  ...
  public void testConstants() {
    ...
    assertEquals(
      ...
      "ONLY \"UTF-16LE\" text encoding specified"
    );
  }
}
