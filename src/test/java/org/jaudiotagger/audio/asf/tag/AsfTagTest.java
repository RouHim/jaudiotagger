...
public class AsfTagTest {
  ...
  public void testEmptyField() throws FieldDataInvalidException {
    ...
    assertEquals(0, asfTag.getFieldCount());
  ...
  public void testIdentifierConversion() throws FieldDataInvalidException {
    ...
    TagField albumField = asfTag.createField(
      FieldKey.ALBUM,
    ...
    assertSame(
      albumField,
      asfTag.getFields(AsfFieldKey.ALBUM.getFieldName()).get(0)
    );
  }
  ...
  public void testMixedIdentifiers() {
    final AsfTag asfTag = new AsfTag();
    AsfTagTextField textField = asfTag.createField(
      AsfFieldKey.ALBUM,
      AsfFieldKey.ALBUM.toString()
    );
    asfTag.setField(textField);
    assertSame(
      textField,
      asfTag.getFirstField(AsfFieldKey.ALBUM.getFieldName())
    );
  }
