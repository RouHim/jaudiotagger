...
public class FlacHeaderTest {
    ...
    public void testReadFileWithVorbisComment() {
        ...
        try {
            ...
            assertEquals("coverart.gif", new String(image.getImageData(), StandardCharsets.ISO_8859_1));
            ...
            assertEquals("-->", image.getMimeType());
            assertTrue(image.isImageUrl());
            assertEquals("../testdata/coverart.jpg", new String(image.getImageData(), StandardCharsets.ISO_8859_1));
