...
public class MP3AudioHeaderTest {
    ...
    public void testReadV1L3VbrOld() {
        ...
        assertEquals(MPEGFrameHeader.mpegVersionMap.get(Integer.valueOf(MPEGFrameHeader.VERSION_1)), mp3AudioHeader.getMpegVersion());
        assertEquals(MPEGFrameHeader.mpegLayerMap.get(Integer.valueOf(MPEGFrameHeader.LAYER_III)), mp3AudioHeader.getMpegLayer());
        assertEquals(MPEGFrameHeader.modeMap.get(Integer.valueOf(MPEGFrameHeader.MODE_MONO)), mp3AudioHeader.getChannels());
    ...
    public void testReadV2L3VbrOld() {
        ...
        assertEquals("00:14", mp3AudioHeader.getTrackLengthAsString());
        assertTrue(mp3AudioHeader.isVariableBitRate());
        assertEquals(MPEGFrameHeader.mpegVersionMap.get(Integer.valueOf(MPEGFrameHeader.VERSION_2)), mp3AudioHeader.getMpegVersion());
        assertEquals(MPEGFrameHeader.mpegLayerMap.get(Integer.valueOf(MPEGFrameHeader.LAYER_III)), mp3AudioHeader.getMpegLayer());
        assertEquals(MPEGFrameHeader.modeMap.get(Integer.valueOf(MPEGFrameHeader.MODE_MONO)), mp3AudioHeader.getChannels());
        assertTrue(mp3AudioHeader.isOriginal());
        assertFalse(mp3AudioHeader.isCopyrighted());
    ...
    public void testReadV1L2Stereo() {
        ...
        assertFalse(mp3AudioHeader.isVariableBitRate());
        assertEquals(MPEGFrameHeader.mpegVersionMap.get(Integer.valueOf(MPEGFrameHeader.VERSION_1)), mp3AudioHeader.getMpegVersion());
        assertEquals(MPEGFrameHeader.mpegLayerMap.get(Integer.valueOf(MPEGFrameHeader.LAYER_II)), mp3AudioHeader.getMpegLayer());
        assertEquals(MPEGFrameHeader.modeMap.get(Integer.valueOf(MPEGFrameHeader.MODE_STEREO)), mp3AudioHeader.getChannels());
    ...
    public void testReadV25L3VbrOld() {
        ...
        assertEquals("00:14", mp3AudioHeader.getTrackLengthAsString());
        assertTrue(mp3AudioHeader.isVariableBitRate());
        assertEquals(MPEGFrameHeader.mpegVersionMap.get(Integer.valueOf(MPEGFrameHeader.VERSION_2_5)), mp3AudioHeader.getMpegVersion());
        assertEquals(MPEGFrameHeader.mpegLayerMap.get(Integer.valueOf(MPEGFrameHeader.LAYER_III)), mp3AudioHeader.getMpegLayer());
        assertEquals(MPEGFrameHeader.modeMap.get(Integer.valueOf(MPEGFrameHeader.MODE_MONO)), mp3AudioHeader.getChannels());
        assertTrue(mp3AudioHeader.isOriginal());
        assertFalse(mp3AudioHeader.isCopyrighted());
    ...
    public void testReadV2L2() {
        ...
        assertEquals(MPEGFrameHeader.mpegVersionMap.get(Integer.valueOf(MPEGFrameHeader.VERSION_2)), mp3AudioHeader.getMpegVersion());
        assertEquals(MPEGFrameHeader.mpegLayerMap.get(Integer.valueOf(MPEGFrameHeader.LAYER_II)), mp3AudioHeader.getMpegLayer());
        assertEquals(MPEGFrameHeader.modeMap.get(Integer.valueOf(MPEGFrameHeader.MODE_JOINT_STEREO)), mp3AudioHeader.getChannels());
