...
public class M4aReadTagTest {
  ...
  public void testReadFile() {
    ...
    try {
      ...
      assertEquals(
        Short.valueOf("1"),
        ((Mp4TrackField) mp4tag.getFirstField(Mp4FieldKey.TRACK)).getTrackNo()
      );
      assertEquals(
        Short.valueOf("10"),
      ...
      BufferedImage bi = ImageIO.read(
        ImageIO.createImageInputStream(
          new ByteArrayInputStream(coverArtField.getData())
        )
      );
      assertNotNull(bi);
    } catch (Exception e) {
  ...
  public void testReadFileFromMediaMonkey306() {
    ...
    try {
      ...
      assertEquals(
        "originalartist",
        mp4tag.getFirst(Mp4FieldKey.MM_ORIGINAL_ARTIST)
      );
      assertEquals(
        "originalalbumtitle",
        mp4tag.getFirst(Mp4FieldKey.MM_ORIGINAL_ALBUM_TITLE)
      );
      assertEquals(
        "involvedpeople",
        mp4tag.getFirst(Mp4FieldKey.MM_INVOLVED_PEOPLE)
      );
  ...
  public void testIssue226Mono() throws Exception {
    ...
    try {
      ...
      assertEquals(
        EncoderType.APPLE_LOSSLESS.getDescription(),
