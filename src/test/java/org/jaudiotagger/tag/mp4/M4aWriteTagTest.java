...
public class M4aWriteTagTest {
    ...
    public void testWriteFileSameSize() {
        ...
        try {
            ...
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(0));
            assertEquals(Short.valueOf("2"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(1));
            assertEquals(Short.valueOf("12"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(2));
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(3));
            ...
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(0));
            assertEquals(Short.valueOf("4"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(1));
            assertEquals(Short.valueOf("15"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(2));
    ...
    public void testWriteFileSmallerSize() {
        ...
        try {
            ...
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(0));
            assertEquals(Short.valueOf("1"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(1));
            assertEquals(Short.valueOf("10"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(2));
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(3));
            ...
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(0));
            assertEquals(Short.valueOf("1"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(1));
            assertEquals(Short.valueOf("10"), ((Mp4TagTextNumberField) mp4tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(2));
    ...
    public void testWriteFileAlotLargerSize() {
        ...
        try {
            ...
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(0));
            assertEquals(Short.valueOf("1"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(1));
            assertEquals(Short.valueOf("10"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(2));
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.TRACK).get(0)).getNumbers().get(3));
            ...
            assertEquals(Short.valueOf("0"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(0));
            assertEquals(Short.valueOf("1"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(1));
            assertEquals(Short.valueOf("10"), ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.DISCNUMBER).get(0)).getNumbers().get(2));
...
//            assertEquals(TEST_FILE2_SIZE, testFile.length());
    ...
    public void testWriteFragmented() throws Exception {
        File testFile = AbstractTestCase.copyAudioToTmp("test.m4a", new File("testFragmentedTemp.m4a"));
        AudioFile f = AudioFileIO.read(testFile);
        Tag tag = f.getTag();
        ...
        assertEquals(tag.getFirst(FieldKey.ARTIST), "VERYLONGARTISTNAME");
    }
