...
public class M4aWriteTagTest extends AbstractBaseTestCase {
    ...
    try {
      ...
      tag.setField(
        tag.createField(
          ...
          "e785f700-c1aa-4943-bcee-87dd316a2c31"
        )
      );
      ...
      assertEquals(
        "66027994-edcf-9d89-bec8-0d30077d888c",
      ...
      assertEquals(
        "19c6f0f6-3d6d-4b02-88c7-ffb559d52be6",
      ...
      assertEquals(
        "Sortalbumartist",
        mp4tag.getFirst(Mp4FieldKey.ALBUM_ARTIST_SORT)
      );
      ...
      assertEquals(
        "66027994-edcf-9d89-bec8-0d30077d888c",
        mp4tag.getFirst(Mp4FieldKey.MUSICIP_PUID)
      );
      assertEquals(
        "e785f700-c1aa-4943-bcee-87dd316a2c31",
        mp4tag.getFirst(Mp4FieldKey.MUSICBRAINZ_TRACKID)
      );
      assertEquals(
        "989a13f6-b58c-4559-b09e-76ae0adb94ed",
      ...
      assertEquals(
        "19c6f0f6-3d6d-4b02-88c7-ffb559d52be6",
        mp4tag.getFirst(Mp4FieldKey.MUSICBRAINZ_ALBUMID)
      );
      Mp4TagReverseDnsField rvs = (Mp4TagReverseDnsField) mp4tag.getFirstField(
      ...
      assertEquals(
        "iTunes v7.4.3.1, QuickTime 7.2",
        mp4tag.getFirst(Mp4FieldKey.ENCODER)
      );
      ...
      assertEquals(
        String.valueOf(Mp4RatingValue.EXPLICIT.getId()),
        mp4tag.getFirst(Mp4FieldKey.RATING)
      );
      assertEquals(
  ...
  public void testWriteFileSmallerSize() {
    ...
    try {
      ...
      assertEquals(
        "e785f700-c1aa-4943-bcee-87dd316a2c30",
        tag.getFirst(FieldKey.MUSICBRAINZ_TRACK_ID)
      );
      assertEquals(
        "989a13f6-b58c-4559-b09e-76ae0adb94ed",
  ...
  public void testWriteFileAlotLargerSize() {
    ...
    try {
      ...
      assertEquals(
        "1/10",
        ((Mp4TagTextNumberField) tag.get(Mp4FieldKey.TRACK).get(0)).getContent()
      );
      assertEquals(
        Short.valueOf("0"),
      ...
      assertEquals(
        "Sortalbumartist",
        tag.getFirst(Mp4FieldKey.ALBUM_ARTIST_SORT)
      );
      ...
      assertEquals(
        "66027994-edcf-9d89-bec8-0d30077d888c",
        tag.getFirst(Mp4FieldKey.MUSICIP_PUID)
      );
      assertEquals(
        "e785f700-c1aa-4943-bcee-87dd316a2c30",
        tag.getFirst(Mp4FieldKey.MUSICBRAINZ_TRACKID)
      );
      assertEquals(
        "989a13f6-b58c-4559-b09e-76ae0adb94ed",
        tag.getFirst(Mp4FieldKey.MUSICBRAINZ_ARTISTID)
      );
      assertEquals(
        "989a13f6-b58c-4559-b09e-76ae0adb94ed",
        tag.getFirst(Mp4FieldKey.MUSICBRAINZ_ALBUMARTISTID)
      );
      assertEquals(
        "19c6f0f6-3d6d-4b02-88c7-ffb559d52be6",
        tag.getFirst(Mp4FieldKey.MUSICBRAINZ_ALBUMID)
      );
      Mp4TagReverseDnsField rvs = (Mp4TagReverseDnsField) tag.getFirstField(
        Mp4FieldKey.MUSICBRAINZ_ALBUMID
      );
      assertEquals("com.apple.iTunes", rvs.getIssuer());
      assertEquals("MusicBrainz Album Id", rvs.getDescriptor());
      ...
      assertEquals(
        "iTunes v7.4.3.1, QuickTime 7.2",
        tag.getFirst(Mp4FieldKey.ENCODER)
      );
      ...
      assertEquals(
        String.valueOf(Mp4RatingValue.EXPLICIT.getId()),
        tag.getFirst(Mp4FieldKey.RATING)
      );
      assertEquals(
        String.valueOf(Mp4ContentTypeValue.BOOKLET.getId()),
        tag.getFirst(Mp4FieldKey.CONTENT_TYPE)
      );
  ...
  public void testWriteFileSmallerNoFreeAtoms() {
    ...
    try {
      ...
      //Total FileSize should not have changed
      assertThat(testFile.length()).isBetween(
        TEST_FILE2_SIZE - 100,
        TEST_FILE2_SIZE + 100
      );
