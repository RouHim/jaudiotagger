...
public class WmaDescriptionLocationTest extends WmaTestCase {
  ...
  public WmaDescriptionLocationTest() throws Exception {
    ...
    this.testTag.setField(
      this.testTag.createField(AsfFieldKey.ISVBR, Boolean.TRUE.toString())
    );
  }
   ...
   * @throws Exception on I/O Errors.
   */
  private void applyTag(File testFile, boolean hcd, boolean hecd)
    throws Exception {
    ...
    WriteableChunkModifer cdCreator = new WriteableChunkModifer(
   ...
   * @throws Exception on I/O Errors
   */
  private void checkExcpectations(
    File testFile,
    boolean hcd,
    boolean hecd,
    boolean ehcd,
    ...
    assertEquals(
      ...
      readHeader.getExtendedHeader() != null &&
        readHeader.getExtendedHeader().getContentDescription() != null
    );
    assertEquals(
      ehecd,
      readHeader.getExtendedHeader() != null &&
