...
public class CompressedTest extends AbstractTestCase {
  ...
  public void testv23TagReadCompressedCommentFrame() throws Exception {
    ...
    ID3v23Frame frame = (ID3v23Frame) v23tag.getFrame(
      ID3v23Frames.FRAME_ID_V3_COMMENT
    );
    assertTrue(
      ((ID3v23Frame.EncodingFlags) frame.getEncodingFlags()).isCompression()
    );
  ...
  public void testv24TagReadCompressedPictureFrame() throws Exception {
    ...
    ID3v24Frame frame = (ID3v24Frame) v24tag.getFrame(
      ID3v24Frames.FRAME_ID_ATTACHED_PICTURE
    );
    assertTrue(
      ((ID3v24Frame.EncodingFlags) frame.getEncodingFlags()).isCompression()
    );
