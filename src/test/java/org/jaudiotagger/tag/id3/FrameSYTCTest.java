...
public class FrameSYTCTest extends AbstractTestCase {
    ...
    public void testSaveToFile() throws Exception {
        ...
        final FrameBodySYTC referenceBody =
                (FrameBodySYTC) referenceFrame.getBody();
        ...
        ID3v24Frame frame = (ID3v24Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v24Frames.FRAME_ID_SYNC_TEMPO);
        FrameBodySYTC body = (FrameBodySYTC) frame.getBody();
        assertEquals(referenceBody.getTimestampFormat(), body.getTimestampFormat());

        final Iterator<Map.Entry<Long, Integer>> reference = referenceBody
                .getTempi()
                .entrySet()
                .iterator();
        final Iterator<Map.Entry<Long, Integer>> loaded = body
                .getTempi()
                .entrySet()
                .iterator();
