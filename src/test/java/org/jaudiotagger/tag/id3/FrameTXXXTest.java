...
public class FrameTXXXTest extends AbstractTestCase {
    ...
    public void testSaveToFile() throws Exception {
        ...
        ID3v24Frame frame = (ID3v24Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO);
    ...
    public void testConvertV24ToV23() throws Exception {
        ...
        ID3v23Frame frame = (ID3v23Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v23Frames.FRAME_ID_V3_USER_DEFINED_INFO);
        FrameBodyTXXX body = (FrameBodyTXXX) frame.getBody();
        assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
    ...
    public void testConvertV24ToV22() throws Exception {
        ...
        ID3v22Frame frame = (ID3v22Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO);
        FrameBodyTXXX body = (FrameBodyTXXX) frame.getBody();
        assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
        assertEquals(FrameBodyTXXXTest.TXXX_TEST_DESC, body.getText());
    }
    ...
    public void testConvertV22ToV24() throws Exception {
        ...
        ((FrameBodyTXXX) id3v22frame.getBody()).setText(
                FrameBodyTXXXTest.TXXX_TEST_STRING
        );
