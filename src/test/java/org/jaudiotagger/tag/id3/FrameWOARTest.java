...
public class FrameWOARTest extends AbstractTestCase {
  ...
  public static final String NORMAL_LINK =
    "http:www.btinternet.com/~birdpoo/kots.htm";

  //Note cant put Japanese chars directly into code because the source code is not a UTF8 file
  public static final String UNICODE_LINK_START =
    "http://ja.wikipedia.org/wiki/";
  public static final String UNICODE_LINK_END = "\u5742\u672c\u4e5d";
  public static final String UNICODE_ENCODED =
    "http://ja.wikipedia.org/wiki/%E5%9D%82%E6%9C%AC%E4%B9%9D";
  public static final String UNICODE_LINK =
  ...
  public static ID3v24Frame getInitialisedUnicodeFrame() throws Exception {
    ...
    fb.setUrlLink(
      UNICODE_LINK_START +
        URLEncoder.encode(UNICODE_LINK_END, StandardCharsets.UTF_8)
    );
  ...
  public void testCreateID3v24Frame() {
    ...
    assertEquals(
      FrameWOARTest.NORMAL_LINK,
      ((FrameBodyWOAR) frame.getBody()).getUrlLink()
    );
  }
