...
public class FramePOPMTest extends AbstractTestCase {
  ...
  private static final String ISSUE_72_TEST_EMAIL =
  ...
  public void testCreateID3v24Frame() {
    ...
    assertEquals(
      ...
      ((FrameBodyPOPM) frame.getBody()).getEmailToUser()
    );
    assertEquals(
      FrameBodyPOPMTest.POPM_RATING,
      ((FrameBodyPOPM) frame.getBody()).getRating()
    );
    assertEquals(
      FrameBodyPOPMTest.POPM_COUNTER,
      ((FrameBodyPOPM) frame.getBody()).getCounter()
    );
    assertFalse(
  ...
  public void testSaveToFile() throws Exception {
    ...
    ID3v24Frame frame = (ID3v24Frame) mp3File
      .getID3v2Tag()
      .getFrame(ID3v24Frames.FRAME_ID_POPULARIMETER);
