...
public class ID3v11TagTest extends AbstractBaseTestCase {
  ...
  public void testCreateID3v11Tag() throws Exception {
    ...
    assertEquals(
      ID3v1TagTest.ARTIST,
      ((TagTextField) v11Tag.getArtist().get(0)).getContent()
    );
    assertEquals(
      ID3v1TagTest.ALBUM,
      ((TagTextField) v11Tag.getAlbum().get(0)).getContent()
    );
    assertEquals(
      ID3v1TagTest.COMMENT,
      ((TagTextField) v11Tag.getComment().get(0)).getContent()
    );
    assertEquals(
      ID3v1TagTest.TITLE,
      ((TagTextField) v11Tag.getTitle().get(0)).getContent()
    );
    assertEquals(
      ID3v1TagTest.GENRE_VAL,
      ((TagTextField) v11Tag.getGenre().get(0)).getContent()
    );
    assertEquals(
      ID3v1TagTest.TRACK_VALUE,
      ((TagTextField) v11Tag.getTrack().get(0)).getContent()
    );
    assertEquals(
      ID3v1TagTest.YEAR,
      ((TagTextField) v11Tag.getYear().get(0)).getContent()
    );
  ...
  public void testNewInterface() {
    ...
    assertEquals(
      "artist",
      ((TagTextField) v1Tag.getFields(FieldKey.ARTIST).get(0)).getContent()
    );
    assertEquals("artist", v1Tag.getFirst(FieldKey.ARTIST));
    assertEquals(
      "artist",
      ((TagTextField) (v1Tag.getArtist().get(0))).getContent()
    );
    assertEquals(
      "artist",
      ((TagTextField) v1Tag.getFirstField(FieldKey.ARTIST.name())).getContent()
    );
    assertEquals(
      "artist",
      ((TagTextField) (v1Tag
    ...
    assertEquals(
      "album",
      ((TagTextField) v1Tag.getFields(FieldKey.ALBUM).get(0)).getContent()
    );
    ...
    assertEquals(
      "album",
      ((TagTextField) v1Tag.getFirstField(FieldKey.ALBUM.name())).getContent()
    );

    v1Tag.setField(new ID3v1TagField(FieldKey.TITLE.name(), "title"));
    assertEquals(
      "title",
      ((TagTextField) v1Tag.getFields(FieldKey.TITLE).get(0)).getContent()
    );
    assertEquals("title", v1Tag.getFirst(FieldKey.TITLE));
    assertEquals(
      "title",
      ((TagTextField) (v1Tag.getTitle().get(0))).getContent()
    );
    assertEquals(
      "title",
      ((TagTextField) v1Tag.getFirstField(FieldKey.TITLE.name())).getContent()
    );

    v1Tag.setField(new ID3v1TagField(FieldKey.YEAR.name(), "year"));
    assertEquals(
      "year",
      ((TagTextField) v1Tag.getFields(FieldKey.YEAR).get(0)).getContent()
    );
    assertEquals("year", v1Tag.getFirst(FieldKey.YEAR));
    assertEquals(
      "year",
      ((TagTextField) (v1Tag.getYear().get(0))).getContent()
    );
    assertEquals(
      "year",
      ((TagTextField) v1Tag.getFirstField(FieldKey.YEAR.name())).getContent()
    );

    v1Tag.setField(new ID3v1TagField(FieldKey.GENRE.name(), "Country"));
    assertEquals(
      "Country",
      ((TagTextField) v1Tag.getFields(FieldKey.GENRE).get(0)).getContent()
    );
    assertEquals("Country", v1Tag.getFirst(FieldKey.GENRE));
    assertEquals(
      "Country",
      ((TagTextField) (v1Tag.getGenre().get(0))).getContent()
    );
    assertEquals(
      "Country",
      ((TagTextField) v1Tag.getFirstField(FieldKey.GENRE.name())).getContent()
    );

    v1Tag.setField(new ID3v1TagField(FieldKey.COMMENT.name(), "comment"));
    assertEquals(
      "comment",
      ((TagTextField) v1Tag.getFields(FieldKey.COMMENT).get(0)).getContent()
    );
    ...
    assertEquals(
      "comment",
      ((TagTextField) v1Tag.getFirstField(FieldKey.COMMENT.name())).getContent()
    );

    v1Tag.setField(new ID3v1TagField(FieldKey.TRACK.name(), "5"));
    assertEquals(
      "5",
      ((TagTextField) v1Tag.getFields(FieldKey.TRACK).get(0)).getContent()
    );
    assertEquals("5", v1Tag.getFirst(FieldKey.TRACK));
    assertEquals("5", ((TagTextField) (v1Tag.getTrack().get(0))).getContent());
    assertEquals(
      "5",
      ((TagTextField) v1Tag.getFirstField(FieldKey.TRACK.name())).getContent()
    );
