...
public class Unicode23TagTest extends AbstractBaseTestCase {
    ...
    public void testCreateISO8859EncodedSizeTerminatedString() throws Exception {
        ...
        frame = (ID3v23Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v23Frames.FRAME_ID_V3_ARTIST);
    ...
    public void testCreateUTF16AutoEncodedSizeTerminatedString()
        ...
        assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
        assertEquals(
                FrameBodyTPE1Test.TPE1_UNICODE_REQUIRED_TEST_STRING,
                fb.getText()
        );
    ...
    public void testFixv23TagsWithInvalidEncoding() throws Exception {
        ...
        ID3v23Frame artistFrame = (ID3v23Frame) v23tag.getFrame(
        ...
        //Currently contains tags with invalid textencodings
        artistFrame = (ID3v23Frame) v23tag.getFrame(
                ID3v23Frames.FRAME_ID_V3_ARTIST
        );
     ...
     */
    @Test
    public void testCreateUTF16BOMLEEvenIfNotNeededIfDefaultSetEncodedSizeTerminatedString()
            throws Exception {
        //Modify tag options
        ...
        try {
            frame
                    .getBody()
                    .setObjectValue(DataTypes.OBJ_TEXT, FrameBodyTPE1Test.TPE1_TEST_STRING);
        } catch (Exception e) {
            exceptionCaught = e;
        }
        assertNull(exceptionCaught);
