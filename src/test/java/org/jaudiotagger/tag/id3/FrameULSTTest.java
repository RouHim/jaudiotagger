...
public class FrameULSTTest extends AbstractTestCase {
  ...
  public void testReadULST() throws Exception {
    ...
    ID3v24Frame v24frame = (ID3v24Frame) mp3File
      .getID3v2Tag()
      .getFrame(ID3v24Frames.FRAME_ID_UNSYNC_LYRICS);
  ...
  public void testWriteULSTID3v23() throws Exception {
    ...
    lyricsBody.setDescription("description");
    lyricsBody.setLyric("lyric1");
    ID3v23Frame v23frame = new ID3v23Frame(
    ...
    //Check normal values
    mp3File = new MP3File(testFile);
    v23frame = (ID3v23Frame) mp3File
      .getID3v2Tag()
      .getFrame(ID3v23Frames.FRAME_ID_V3_UNSYNC_LYRICS);
