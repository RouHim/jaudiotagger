...
public class FrameTSOCTest extends AbstractTestCase {
    ...
    public void testCreateID3v24Frame() {
        ...
        assertEquals(
                ...
                ((FrameBodyTSOC) frame.getBody()).getText()
        );
    }
    ...
    public void testSaveToFile() throws Exception {
        ...
        ID3v24Frame frame = (ID3v24Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v24Frames.FRAME_ID_COMPOSER_SORT_ORDER_ITUNES);
    ...
    public void testConvertV24ToV23() throws Exception {
        ...
        ID3v23Frame frame = (ID3v23Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v23Frames.FRAME_ID_V3_COMPOSER_SORT_ORDER_ITUNES);
        FrameBodyTSOC body = (FrameBodyTSOC) frame.getBody();
        assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
    ...
    public void testConvertV24ToV22() throws Exception {
        ...
        ID3v22Frame frame = (ID3v22Frame) mp3File
                .getID3v2Tag()
                .getFrame(ID3v22Frames.FRAME_ID_V2_COMPOSER_SORT_ORDER_ITUNES);
        FrameBodyTSOC body = (FrameBodyTSOC) frame.getBody();
        assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
        assertEquals(FrameBodyTSOCTest.COMPOSER_SORT, body.getText());
    }
    ...
    public void testConvertV22ToV24() throws Exception {
        ...
        ((FrameBodyTSOC) id3v22frame.getBody()).setText(
                FrameBodyTSOCTest.COMPOSER_SORT
        );
