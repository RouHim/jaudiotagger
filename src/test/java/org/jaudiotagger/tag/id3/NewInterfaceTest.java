...
public class NewInterfaceTest extends AbstractBaseTestCase {
    ...
    public void testNewInterfaceBasicReadandWriteID3v24() throws Exception {
        ...
        ((FrameBodyTPE1) frame.getBody()).setText(
                FrameBodyTPE1Test.TPE1_TEST_STRING
        );
        tag.setFrame(frame);
        ...
        assertEquals(
                FrameBodyTPE1Test.TPE1_TEST_STRING,
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.ARTIST)
        );
        assertEquals(
                FrameBodyTPE1Test.TPE1_TEST_STRING,
                ((TagTextField) af.getTag().getFirstField(FieldKey.ARTIST)).getContent()
        );
        //.... but v1 value is still there
        assertEquals(
                V1_ARTIST,
                ((MP3File) af).getID3v1Tag().getFirst(FieldKey.ARTIST)
        );
        ...
        assertEquals(
                ALBUM_TEST_STRING,
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.ALBUM)
        );
        assertEquals(
                ALBUM_TEST_STRING,
                ((TagTextField) af.getTag().getFirstField(FieldKey.ALBUM)).getContent()
        );
        assertEquals(1, af.getTag().getFields(FieldKey.ALBUM).size());

        //Read back album (old method)
        AbstractID3v2Frame checkframe =
                (AbstractID3v2Frame) ((MP3File) af).getID3v2Tag().getFrame(
                        ID3v24Frames.FRAME_ID_ALBUM
                );
        assertEquals(
                ALBUM_TEST_STRING,
                ((FrameBodyTALB) checkframe.getBody()).getText()
        );
        ...
        assertEquals(
                "1991",
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.YEAR)
        );
        assertEquals(
                "1991",
                ((TagTextField) af.getTag().getFirstField(FieldKey.YEAR)).getContent()
        );
        ...
        assertEquals(
                "Title",
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.TITLE)
        );
        assertEquals(
                "Title",
                ((TagTextField) af.getTag().getFirstField(FieldKey.TITLE)).getContent()
        );
        ...
        assertEquals(
                "Comment",
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.COMMENT)
        );

        //By default comments are created with empty description because this is what expected
        //by plyers such as iTunes.
        ID3v24Frame commentFrame = (ID3v24Frame) ((ID3v24Tag) af.getTag()).getFrame(
                "COMM"
        );
        ...
        ((FrameBodyCOMM) ((ID3v24Frame) comments.get(1)).getBody()).setDescription(
                "test2"
        );
        ...
        assertEquals(
                "CustomGenre",
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.GENRE)
        );
        ...
        af
                .getTag()
                .setField(
                        af.getTag().createField(FieldKey.AMAZON_ID, "asin123456" + "\u01ff")
                );
        af.commit();
        af = AudioFileIO.read(testFile);
        ...
        assertEquals(
                "asin123456" + "\u01ff",
                af.getTag().getFirst(FieldKey.AMAZON_ID)
        );
        assertEquals(
                "asin123456" + "\u01ff",
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.AMAZON_ID)
        );
        ...
        af
                .getTag()
                .setField(af.getTag().createField(FieldKey.MUSICIP_ID, "musicip_id"));
        af.commit();
        af = AudioFileIO.read(testFile);
        ...
        assertEquals(
                "musicip_id",
                ((ID3v24Tag) af.getTag()).getFirst(ID3v24FieldKey.MUSICIP_ID)
        );
        ...
        af
                .getTag()
                .setField(
                        af.getTag().createField(FieldKey.MUSICBRAINZ_RELEASEID, "releaseid")
                );
        af.commit();
        af = AudioFileIO.read(testFile);
        ...
        assertEquals(
                "releaseid",
                af.getTag().getFirst(FieldKey.MUSICBRAINZ_RELEASEID)
        );
        assertEquals(
                "releaseid",
                ((TagTextField) af
        ...
        assertEquals(
                1,
                af.getTag().getFields(FieldKey.MUSICBRAINZ_RELEASEID).size()
        );
        ...
        try {
            af
                    .getTag()
                    .setField(af.getTag().createField(FieldKey.COVER_ART, "coverart"));
        ...
        assertEquals(
                1,
                af.getTag().getFields(ID3v24FieldKey.COVER_ART.getFieldName()).size()
        );
        //TODO This isnt very user friendly
        TagField tagField = af
                .getTag()
                .getFirstField(ID3v24FieldKey.COVER_ART.getFieldName());
        assertEquals(
                "image/png::18545",
                ((TagTextField) af
                        .getTag()
        ...
        if (imageField instanceof AbstractID3v2Frame) {
            ...
            if (!imageFrameBody.isImageUrl()) {
                byte[] imageRawData = (byte[]) imageFrameBody.getObjectValue(
        ...
        af
                .getTag()
                .addField(tag.createLinkedArtworkField("../testdata/coverart.jpg"));
        af.commit();
    ...
    public void testNewInterfaceBasicReadandWriteID3v23() throws Exception {
        ...
        assertEquals(
                FrameBodyTPE1Test.TPE1_TEST_STRING,
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.ARTIST)
        );
        //.... but v1 value is still there
        assertEquals(
                V1_ARTIST,
        ...
        assertEquals(
                ALBUM_TEST_STRING,
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.ALBUM)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.ALBUM).size());
        ...
        assertEquals(
                "1991",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.YEAR)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.YEAR).size());
        assertEquals(2, af.getTag().getFieldCount());
        ...
        assertEquals(
                "Title",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.TITLE)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.TITLE).size());
        assertEquals(3, af.getTag().getFieldCount());
        ...
        assertEquals(
                "Comment",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.COMMENT)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.COMMENT).size());
        assertEquals(4, af.getTag().getFieldCount());
        ...
        assertEquals(
                "CustomGenre",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.GENRE)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.GENRE).size());
        assertEquals(5, af.getTag().getFieldCount());
        ...
        assertEquals(
                "asin123456" + "\u01ff",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.AMAZON_ID)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.AMAZON_ID).size());
        ...
        assertEquals(
                "musicip_id",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.MUSICIP_ID)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.MUSICIP_ID).size());
        assertEquals(
                "asin123456" + "\u01ff",
        ...
        assertEquals(
                "11",
                ((ID3v23Tag) af.getTag()).getFirst(ID3v23FieldKey.TRACK_TOTAL)
        );
    ...
    public void testNewInterfaceBasicReadandWriteID3v22() throws Exception {
        ...
        assertEquals(
                FrameBodyTPE1Test.TPE1_TEST_STRING,
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.ARTIST)
        );
        //.... but v1 value is still there
        assertEquals(
                V1_ARTIST,
        ...
        assertEquals(
                ALBUM_TEST_STRING,
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.ALBUM)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.ALBUM).size());
        ...
        assertEquals(
                "1991",
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.YEAR)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.YEAR).size());
        assertEquals(2, af.getTag().getFieldCount());
        ...
        assertEquals(
                "Title",
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.TITLE)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.TITLE).size());
        assertEquals(3, af.getTag().getFieldCount());
        ...
        assertEquals(
                "Comment",
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.COMMENT)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.COMMENT).size());
        assertEquals(4, af.getTag().getFieldCount());
        ...
        assertEquals(
                "CustomGenre",
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.GENRE)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.GENRE).size());
        assertEquals(5, af.getTag().getFieldCount());
        ...
        assertEquals(
                "asin123456" + "\u01ff",
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.AMAZON_ID)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.AMAZON_ID).size());
        assertEquals(7, af.getTag().getFieldCount());
        ...
        assertEquals(
                "musicip_id",
                ((ID3v22Tag) af.getTag()).getFirst(ID3v22FieldKey.MUSICIP_ID)
        );
        assertEquals(1, af.getTag().getFields(FieldKey.MUSICIP_ID).size());
        assertEquals(
                "asin123456" + "\u01ff",
    ...
    public void testSettingMultipleFramesofSameType() throws Exception {
        ...
        //COMM
        {
            ID3v24Frame commentFrame =
                    (ID3v24Frame) ((ID3v24Tag) af.getTag()).getFrame("COMM");
            FrameBodyCOMM fb = (FrameBodyCOMM) commentFrame.getBody();
            assertEquals("", fb.getDescription());
            assertEquals("Comment", fb.getText());
            //Change description, cant do this with common interface
            ...
            af
                    .getTag()
                    .setField(af.getTag().createField(FieldKey.COMMENT, "abcdef-ghijklmn"));
        ...
        //TXXX
        {
            ...
            af
                    ...
                    .setField(
                            af
                                    .getTag()
                                    .createField(FieldKey.MUSICBRAINZ_ARTISTID, "abcdef-ghijklmn")
                    );
            ...
            af
                    .getTag()
                    .setField(
                            af.getTag().createField(FieldKey.MUSICBRAINZ_ARTISTID, "abcfffff")
                    );
            assertEquals(2, ((List) tag.getFrame("TXXX")).size());
        ...
        //UFID
        {
            ...
            af
                    ...
                    .setField(
                            af
                                    .getTag()
                                    .createField(FieldKey.MUSICBRAINZ_TRACK_ID, "abcdef-ghijklmn")
                    );
            ...
            af
                    .getTag()
                    .setField(
                            af.getTag().createField(FieldKey.MUSICBRAINZ_TRACK_ID, "abcfffff")
                    );
            assertEquals(2, ((List) tag.getFrame("UFID")).size());
        ...
        //ULST
        {
            ...
            af
                    .getTag()
                    .setField(af.getTag().createField(FieldKey.LYRICS, "abcdef-ghijklmn"));
            ...
            af
                    .getTag()
                    .setField(af.getTag().createField(FieldKey.LYRICS, "abcfffff"));
            assertEquals(2, ((List) tag.getFrame("USLT")).size());
            assertEquals(2, af.getTag().getFields(FieldKey.LYRICS).size());
        }
