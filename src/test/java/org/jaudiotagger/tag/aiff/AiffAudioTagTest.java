...
public class AiffAudioTagTest extends FilePermissionsTest {
    ...
    public void testReadAiff2() {
        ...
        try {
            ...
            assertEquals(0, tag.getFirst(FieldKey.TITLE).indexOf("Short sample"));
            assertEquals(
            ...
            assertEquals(
                    2254L,
                    ((AiffTag) tag).getSizeOfID3TagIncludingChunkHeader()
            );
    ...
    public void testDeleteAiff3() {
        ...
        try {
            ...
            assertNotEquals(
                    oldSize,
                    newSize,
                    "FORM chunk size should have changed, but hasn't."
            );
        } catch (Exception ex) {
            ex.printStackTrace();
            exceptionCaught = ex;
    ...
    public void testDeleteAiff4() {
        ...
        try {
            ...
            assertEquals(3, oldChunkIds.size());
            ...
            assertEquals(2, newChunkIds.size());
        } catch (Exception ex) {
            ex.printStackTrace();
            exceptionCaught = ex;
        }
    ...
    public void testWriteNotLastChunk() {
        ...
        try {
            ...
            assertEquals(3, newChunkIds.size());
        } catch (Exception ex) {
            ex.printStackTrace();
            exceptionCaught = ex;
        }
    ...
    public void testDeleteOddLengthID3ChunkFile() {
        ...
        try {
            ...
            assertEquals(
                    0,
                    ((AiffTag) f.getTag()).getStartLocationInFileOfId3Chunk()
            );
            assertEquals(
                    0,
                    ((AiffTag) f.getTag()).getSizeOfID3TagIncludingChunkHeader()
            );
