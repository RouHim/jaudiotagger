...
public class Issue242Test extends AbstractTestCase {
  ...
  public void testWriteNewUrlsFilev24() {
    ...
    try {
      ...
      long mp3AudioLength =
        testFile.length() - mp3File.getMP3AudioHeader().getMp3StartByte();
      ...
      assertEquals(
        0,
        mp3File.getTag().getFields(FieldKey.URL_OFFICIAL_ARTIST_SITE).size()
      );
      assertEquals(
        0,
        mp3File.getTag().getFields(FieldKey.URL_DISCOGS_RELEASE_SITE).size()
      );
      assertEquals(
        0,
        mp3File.getTag().getFields(FieldKey.URL_DISCOGS_ARTIST_SITE).size()
      );
      assertEquals(
        0,
        mp3File.getTag().getFields(FieldKey.URL_WIKIPEDIA_RELEASE_SITE).size()
      );
      assertEquals(
        0,
        mp3File.getTag().getFields(FieldKey.URL_WIKIPEDIA_ARTIST_SITE).size()
      );
      assertEquals(
        0,
        mp3File.getTag().getFields(FieldKey.URL_LYRICS_SITE).size()
      );
      ...
      mp3File
        ...
        .setField(
          mp3File
            .getTag()
            .createField(FieldKey.URL_OFFICIAL_RELEASE_SITE, "http://test1")
        );
      mp3File
        .getTag()
        .setField(
          mp3File
            .getTag()
            .createField(FieldKey.URL_DISCOGS_RELEASE_SITE, "http://test2")
        );
      mp3File
        .getTag()
        .setField(
          mp3File
            .getTag()
            .createField(FieldKey.URL_DISCOGS_ARTIST_SITE, "http://test3")
        );
      mp3File
        .getTag()
        .setField(
          mp3File
            .getTag()
            .createField(FieldKey.URL_WIKIPEDIA_RELEASE_SITE, "http://test4")
        );
      mp3File
        .getTag()
        .setField(
          mp3File
            .getTag()
            .createField(FieldKey.URL_WIKIPEDIA_ARTIST_SITE, "http://test5")
        );
      mp3File
        .getTag()
        .setField(
          mp3File
            .getTag()
            .createField(FieldKey.URL_OFFICIAL_ARTIST_SITE, "http://test6")
        );
      mp3File
        .getTag()
        .setField(
          mp3File.getTag().createField(FieldKey.URL_LYRICS_SITE, "http://test7")
        );
      mp3File.save();
