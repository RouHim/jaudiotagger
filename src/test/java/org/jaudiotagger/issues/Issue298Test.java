...
public class Issue298Test extends AbstractTestCase {
    ...
    try {
      ...
      tag.setField(
        tag.createField(
          ...
          "c1f657ba-8177-3cbb-b84a-f62bc684a94e"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_RELEASE_TRACK_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94f"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_ID,
          "0410c22a-0b2b-4793-9f18-5f1fab36338e"
        )
      );
      ...
      tag.setField(
        tag.createField(FieldKey.ORIGINAL_LYRICIST, "original_lyricist")
      );
      tag.setField(
        tag.createField(FieldKey.ORIGINAL_ARTIST, "original_artist")
      );
      ...
      tag.setField(
        tag.createField(FieldKey.PERFORMER_NAME_SORT, "PerformerNameSort")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94g"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94g"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94h"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94i"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94j"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94k"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6_ID,
          "c1f657ba-8177-3cbb-b84a-f62bc684a94l"
        )
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_COMPOSITION,
          "MusicBrainzWorkComposition"
        )
      );
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1, "Level1")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1_TYPE,
          "Level1Type"
        )
      );
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2, "Level2")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2_TYPE,
          "Level2Type"
        )
      );
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3, "Level3")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3_TYPE,
          "Level3Type"
        )
      );
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4, "Level4")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4_TYPE,
          "Level4Type"
        )
      );
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5, "Level5")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5_TYPE,
          "Level5Type"
        )
      );
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6, "Level6")
      );
      tag.setField(
        tag.createField(
          FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6_TYPE,
          "Level6Type"
        )
      );
      ...
      tag.setField(
        tag.createField(FieldKey.SINGLE_DISC_TRACK_NO, "SingleDiscTrackNo")
      );
      ...
      tag.setField(
        tag.createField(FieldKey.CLASSICAL_CATALOG, "classicalcatalog")
      );
      tag.setField(
        tag.createField(FieldKey.CLASSICAL_NICKNAME, "classicalnickname")
      );
      ...
      tag.setField(
        tag.createField(FieldKey.ALBUM_ARTISTS_SORT, "AlbumArtistsSort")
      );
      tag.setField(tag.createField(FieldKey.TITLE_MOVEMENT, "TitleMovement"));
      tag.setField(
        tag.createField(FieldKey.MUSICBRAINZ_WORK, "MusicBrainzWork")
      );
      ...
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94e",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_RELEASE_GROUP_ID)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94f",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_RELEASE_TRACK_ID)
      );
      assertEquals(
        "0410c22a-0b2b-4793-9f18-5f1fab36338e",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_ID)
      );
      assertEquals("Occasion", af.getTag().getFirst(FieldKey.OCCASION));
      assertEquals(
        "original_album",
        af.getTag().getFirst(FieldKey.ORIGINAL_ALBUM)
      );
      assertEquals(
        "original_lyricist",
        af.getTag().getFirst(FieldKey.ORIGINAL_LYRICIST)
      );
      assertEquals(
        "original_artist",
        af.getTag().getFirst(FieldKey.ORIGINAL_ARTIST)
      );
      ...
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94g",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID)
      );
      assertEquals(
        "Composition Type",
        af.getTag().getFirst(FieldKey.PART_TYPE)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94g",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1_ID)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94h",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2_ID)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94i",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3_ID)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94j",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4_ID)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94k",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5_ID)
      );
      assertEquals(
        "c1f657ba-8177-3cbb-b84a-f62bc684a94l",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6_ID)
      );
      assertEquals(
        "MusicBrainzWorkComposition",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_COMPOSITION)
      );
      assertEquals(
        "Level1",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1)
      );
      assertEquals(
        "Level2",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2)
      );
      assertEquals(
        "Level3",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3)
      );
      assertEquals(
        "Level4",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4)
      );
      assertEquals(
        "Level5",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5)
      );
      assertEquals(
        "Level6",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6)
      );
      assertEquals(
        "Level1Type",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1_TYPE)
      );
      assertEquals(
        "Level2Type",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2_TYPE)
      );
      assertEquals(
        "Level3Type",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3_TYPE)
      );
      assertEquals(
        "Level4Type",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4_TYPE)
      );
      assertEquals(
        "Level5Type",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5_TYPE)
      );
      assertEquals(
        "Level6Type",
        af.getTag().getFirst(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6_TYPE)
      );
      ...
      assertEquals(
        "ConductorSort",
        af.getTag().getFirst(FieldKey.CONDUCTOR_SORT)
      );
      assertEquals(
        "EnsembleSort",
        af.getTag().getFirst(FieldKey.ENSEMBLE_SORT)
      );
      assertEquals(
        "OrchestraSort",
        af.getTag().getFirst(FieldKey.ORCHESTRA_SORT)
      );
      assertEquals(
        "ArrangerSort",
        af.getTag().getFirst(FieldKey.ARRANGER_SORT)
      );
      ...
      assertEquals(
        "SingleDiscTrackNo",
        af.getTag().getFirst(FieldKey.SINGLE_DISC_TRACK_NO)
      );
      ...
      assertEquals(
        "PerformerName",
        af.getTag().getFirst(FieldKey.PERFORMER_NAME)
      );
      assertEquals(
        "PerformerNameSort",
        af.getTag().getFirst(FieldKey.PERFORMER_NAME_SORT)
      );
      assertEquals("ensemble", af.getTag().getFirst(FieldKey.ENSEMBLE));
      assertEquals(
        "classicalcatalog",
        af.getTag().getFirst(FieldKey.CLASSICAL_CATALOG)
      );
      assertEquals(
        "classicalnickname",
        af.getTag().getFirst(FieldKey.CLASSICAL_NICKNAME)
      );
      ...
      assertEquals(
        "AlbumArtists",
        af.getTag().getFirst(FieldKey.ALBUM_ARTISTS)
      );
      assertEquals(
        "AlbumArtistsSort",
        af.getTag().getFirst(FieldKey.ALBUM_ARTISTS_SORT)
      );
      assertEquals(
        "TitleMovement",
        af.getTag().getFirst(FieldKey.TITLE_MOVEMENT)
      );
      assertEquals(
        "MusicBrainzWork",
  ...
  public void testWriteFieldsToMp3ID3v23() {
    ...
    try {
      ...
      while (i.hasNext()) {
        TagField tf = i.next();
        System.out.println(tf.getId() + ":" + tf);
      }
  ...
  public void testWriteFieldsToOggVorbis() {
    ...
    try {
      ...
      tag.setField(
        tag.createField(
          FieldKey.PERFORMER,
          PerformerHelper.formatForNonId3("Nigel Kennedy", "violinist")
        )
      );
      tag.setField(tag.createField(FieldKey.WORK_TYPE, "WorkType"));
      tag.setField(tag.createField(FieldKey.CHOIR_SORT, "ChoirSort"));
      ...
      assertEquals(
        ...
        af.getTag().getFirst(FieldKey.PERFORMER)
      );
      assertEquals("WorkType", af.getTag().getFirst(FieldKey.WORK_TYPE));
      assertEquals("ChoirSort", af.getTag().getFirst(FieldKey.CHOIR_SORT));
      assertEquals(
