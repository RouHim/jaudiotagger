...
public class Issue269Test extends AbstractTestCase {
    ...
    public void testReadMp3WithEncryptedField() {
        ...
        try {
            ...
            AbstractID3v2Frame frame1 = (AbstractID3v2Frame) id3v23Tag.getFrame(
            ...
            ID3v23Frame frame = (ID3v23Frame) id3v23Tag.getFrame(
                    ID3v23Frames.FRAME_ID_V3_ENCODEDBY
            );
            assertNull(frame);
            frame = (ID3v23Frame) id3v23Tag.getEncryptedFrame(
                    ID3v23Frames.FRAME_ID_V3_ENCODEDBY
            );
            assertNotNull(frame);
            ...
            frame = (ID3v23Frame) id3v23Tag.getFrame(
                    ID3v23Frames.FRAME_ID_V3_ENCODEDBY
            );
            assertNull(frame);
            frame = (ID3v23Frame) id3v23Tag.getEncryptedFrame(
