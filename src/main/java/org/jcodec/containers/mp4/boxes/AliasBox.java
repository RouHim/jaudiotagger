...
public class AliasBox extends FullBox {
  ...
  public static final int DirectoryIDs = 1; // parent & higher directory ids
  // '/' is not counted, one
  ...
  public static final int UFT16VolumeName = 15; // 26
  public static final int VolumeMountPoint = 19; // 1
  ...
  public ExtraField getExtra(int type) {
    for (ExtraField extraField : extra) {
      if (extraField.type == type) return extraField;
    }
    return null;
  }
  ...
  public String getUnixPath() {
    ...
    return extraField == null ? null : "/" + extraField;
  }
}
