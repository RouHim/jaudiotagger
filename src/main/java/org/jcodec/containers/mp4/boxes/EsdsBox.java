...
public class EsdsBox extends FullBox {
  ...
  public static class NodeDescriptor extends Descriptor {
    ...
    private final Collection<Descriptor> children;
  ...
  public static class DescriptorParser {
    ...
    private static final int ES_TAG = 0x03;
    private static final int DC_TAG = 0x04;
    private static final int DS_TAG = 0x05;
    private static final int SL_TAG = 0x06;
  ...
  public void parse(ByteBuffer input) {
    ...
    DecoderConfig decoderConfig = NodeDescriptor.findByTag(
      es,
      DecoderConfig.tag()
    );
    ...
    DecoderSpecific decoderSpecific = NodeDescriptor.findByTag(
      decoderConfig,
      DecoderSpecific.tag()
    );
  ...
  public AudioProfile getAudioProfile() {
    ...
    if (data.remaining() < 1) return AudioProfile.MAIN;
  ...
  public static EsdsBox createEsdsBox(
    ByteBuffer streamInfo,
    int objectType,
    int bufSize,
    int maxBitrate,
    int avgBitrate,
