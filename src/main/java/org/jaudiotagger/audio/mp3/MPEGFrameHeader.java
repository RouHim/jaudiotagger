...
public class MPEGFrameHeader {
  ...
  private static final int MASK_MP3_FREQUENCY =
    FileConstants.BIT3 + FileConstants.BIT2;
  ...
  private static final int MASK_MP3_MODE =
    FileConstants.BIT7 | FileConstants.BIT6;

  /**
   * MP3 Frame Header bit mask
   */
  private static final int MASK_MP3_MODE_EXTENSION =
    FileConstants.BIT5 | FileConstants.BIT4;
  ...
  private static final int MASK_MP3_EMPHASIS =
    FileConstants.BIT1 | FileConstants.BIT0;
  ...
  private void setBitrate() throws InvalidAudioFrameException {
    ...
    int bitRateIndex =
      (mpegBytes[BYTE_3] & MASK_MP3_BITRATE) |
      (mpegBytes[BYTE_2] & MASK_MP3_ID) |
      (mpegBytes[BYTE_2] & MASK_MP3_LAYER);
  ...
  private void setSamplingRate() throws InvalidAudioFrameException {
    ...
    Map<Integer, Integer> samplingRateMapForVersion = samplingRateMap.get(
      version
    );
  ...
  public static boolean isMPEGFrame(ByteBuffer bb) {
    ...
    return (
      ...
      ((bb.get(position + 2) & SYNC_BIT_ANDSAMPING_BYTE3) !=
