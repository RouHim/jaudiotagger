...
public class XingFrame {
    ...
    protected static final Logger log = LoggerFactory.getLogger(XingFrame.class);
    ...
    private void setFrameCount() {
        ...
        frameCount =
                ((frameCountBuffer[BYTE_1] << 24) & 0xFF000000) |
    ...
    private void setAudioSize() {
        ...
        audioSize =
                ((frameSizeBuffer[BYTE_1] << 24) & 0xFF000000) |
     ...
     */
    public static XingFrame parseXingFrame(ByteBuffer header)
            throws InvalidAudioFrameException {
     ...
     */
    public static ByteBuffer isXingFrame(
            ByteBuffer bb,
        ...
        header.get(identifier);
        if (
                (!Arrays.equals(identifier, XING_VBR_ID)) &&
                        (!Arrays.equals(identifier, XING_CBR_ID))
        ) {
            return null;
        }
