...
public class Mp4TagReader {
     ...
     */
    public Mp4Tag read(RandomAccessFile raf)
        ...
        if (meta == null) {
            log.warn(ErrorMessage.MP4_FILE_HAS_NO_METADATA.getMsg());
            return tag;
        }
                        ...
                        default:
                            switch (key.getSubClassFieldType()) {
                                ...
                                case BYTE:
                                    ...
                                    tag.addField(
                                            new Mp4TagTextSingleNumberField(key.getFieldName(), number)
                                    );
                                    break;
                            }
                            break;
