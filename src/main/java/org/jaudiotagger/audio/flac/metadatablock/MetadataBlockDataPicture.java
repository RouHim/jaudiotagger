...
public class MetadataBlockDataPicture implements MetadataBlockData, TagField {
  ...
  private static final Logger logger = LoggerFactory.getLogger(
    "org.jaudiotagger.audio.flac.MetadataBlockDataPicture"
  );

  private void initFromByteBuffer(ByteBuffer rawdata)
   ...
   */
  public MetadataBlockDataPicture(
    byte[] imageData,
    int pictureType,
    String mimeType,
    String description,
  ...
  private String getString(ByteBuffer rawdata, int length, String charset)
    throws IOException {
  ...
  public String toString() {
    return (
      PictureTypes.getInstanceOf().getValueForId(pictureType) +
      ":" +
      mimeType +
      ":" +
      description +
