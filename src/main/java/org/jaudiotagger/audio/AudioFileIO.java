...
public class AudioFileIO {
    ...
    public void deleteTag(AudioFile f)
        ...
        if (afw == null) {
            throw new CannotWriteException(
                    ErrorMessage.NO_DELETER_FOR_THIS_FORMAT.getMsg(ext)
            );
        }
    ...
    public AudioFile readFileAs(File f, String ext)
        ...
        if (afr == null) {
            throw new CannotReadException(
                    ErrorMessage.NO_READER_FOR_THIS_FORMAT.getMsg(ext)
            );
        }
     ...
     *                                     wasn't recognized, or other IO error occurred.
     */
    public void writeFile(AudioFile f, String targetPath)
        ...
        if (afw == null) {
            throw new CannotWriteException(
                    ErrorMessage.NO_WRITER_FOR_THIS_FORMAT.getMsg(ext)
            );
        }
     ...
     *                                     wasn't recognized, or other IO error occurred.
     */
    public static void writeAs(AudioFile f, String targetPath)
            throws CannotWriteException {
        if (targetPath == null || targetPath.isEmpty()) {
