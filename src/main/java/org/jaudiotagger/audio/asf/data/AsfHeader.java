...
public final class AsfHeader extends ChunkContainer {
   ...
   */
  public static final Charset ASF_CHARSET = StandardCharsets.UTF_16LE;
  ...
  public MetadataContainer findMetadataContainer(final ContainerType type) {
    MetadataContainer result = (MetadataContainer) getFirst(
      type.getContainerGUID(),
  ...
  public ContentDescription getContentDescription() {
    return (ContentDescription) getFirst(
  ...
  public EncryptionChunk getEncryptionChunk() {
    return (EncryptionChunk) getFirst(
  ...
  public AsfExtendedHeader getExtendedHeader() {
    return (AsfExtendedHeader) getFirst(
