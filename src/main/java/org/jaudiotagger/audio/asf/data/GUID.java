...
public final class GUID {
   ...
   */
  public static final GUID GUID_AUDIO_ERROR_CONCEALEMENT_ABSENT = new GUID(
    new int[] {
      0x40,
      0xA4,
      0xF1,
   ...
   * concealment. <br>
   */
  public static final GUID GUID_AUDIO_ERROR_CONCEALEMENT_INTERLEAVED = new GUID(
    new int[] {
      0x40,
      0xA4,
      0xF1,
   ...
   */
  public static final GUID GUID_AUDIOSTREAM = new GUID(
    new int[] {
      0x40,
      0x9E,
      0x69,
   ...
   */
  public static final GUID GUID_CONTENT_BRANDING = new GUID(
    new int[] {
      0xFA,
      0xB3,
      0x11,
   ...
   */
  public static final GUID GUID_CONTENT_ENCRYPTION = new GUID(
    new int[] {
      0xfb,
      0xb3,
      0x11,
   ...
   */
  public static final GUID GUID_CONTENTDESCRIPTION = new GUID(
    new int[] {
      0x33,
      0x26,
      0xB2,
   ...
   */
  public static final GUID GUID_ENCODING = new GUID(
    new int[] {
      0x40,
      0x52,
      0xD1,
   ...
   * chunk. <br>
   */
  public static final GUID GUID_EXTENDED_CONTENT_DESCRIPTION = new GUID(
    new int[] {
      0x40,
      0xA4,
      0xD0,
   ...
   */
  public static final GUID GUID_FILE = new GUID(
    new int[] {
      0xA1,
      0xDC,
      0xAB,
   ...
   */
  public static final GUID GUID_HEADER = new GUID(
    new int[] {
      0x30,
      0x26,
      0xb2,
   ...
   */
  public static final GUID GUID_HEADER_EXTENSION = new GUID(
    new int[] {
      0xB5,
      0x03,
      0xBF,
   ...
   */
  public static final GUID GUID_LANGUAGE_LIST = new GUID(
    new int[] {
      0xa9,
      0x46,
      0x43,
   ...
   */
  public static final GUID GUID_METADATA = new GUID(
    new int[] {
      0xea,
      0xcb,
      0xf8,
   ...
   */
  public static final GUID GUID_METADATA_LIBRARY = new GUID(
    new int[] {
      0x94,
      0x1c,
      0x23,
   ...
   */
  public static final GUID GUID_STREAM = new GUID(
    new int[] {
      0x91,
      0x07,
      0xDC,
   ...
   * chunk.
   */
  public static final GUID GUID_STREAM_BITRATE_PROPERTIES = new GUID(
    new int[] {
      0xCE,
      0x75,
      0xF8,
   ...
   */
  public static final GUID GUID_UNSPECIFIED = new GUID(
    new int[] {
      0x00,
      0x00,
      0x00,
   ...
   */
  public static final GUID GUID_VIDEOSTREAM = new GUID(
    new int[] {
      0xC0,
      0xEF,
      0x19,
   ...
   */
  public static final GUID SCRIPT_COMMAND_OBJECT = new GUID(
    new int[] {
      0x30,
      0x1a,
      0xfb,
  ...
  public static GUID parseGUID(final String guid) throws GUIDFormatException {
    ...
    for (int i = 0; i < guid.length(); i++) {
      ...
      bytes[arrayIndices[arrayPointer++]] = Integer.parseInt(
        guid.substring(i, i + 2),
        16
      );
      i++;
    }
