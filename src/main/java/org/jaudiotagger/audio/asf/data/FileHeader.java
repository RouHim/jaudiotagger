...
public class FileHeader extends Chunk {
     ...
     */
    public FileHeader(
            final BigInteger chunckLen,
            final BigInteger size,
            final BigInteger fileTime,
            final BigInteger pkgCount,
            final BigInteger dur,
            final BigInteger timestampStart,
            final BigInteger timestampEnd,
            final long headerFlags,
            final long minPkgSize,
            final long maxPkgSize,
    ...
    public String prettyPrint(final String prefix) {
        String result =
                super.prettyPrint(prefix) +
                        ...
                        prefix +
                        "  |-> Media duration= " +
                        getDuration().divide(new BigInteger("10000")) +
                        " ms" +
                        Utils.LINE_SEPARATOR +
                        prefix +
                        "  |-> Created at    = " +
