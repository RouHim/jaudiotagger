...
public enum WavInfoIdentifier {
  ...
  private static final Map<String, WavInfoIdentifier> CODE_TYPE_MAP =
    new HashMap<String, WavInfoIdentifier>();
  private static final Map<FieldKey, WavInfoIdentifier> FIELDKEY_TYPE_MAP =
    new HashMap<FieldKey, WavInfoIdentifier>();
   ...
   */
  public static synchronized WavInfoIdentifier getByCode(final String code) {
   ...
   * @return chunk type or {@code null} if not registered
   */
  public static synchronized WavInfoIdentifier getByByFieldKey(
