...
public class WavCleaner {
    ...
    static void main(final String[] args) throws Exception {
        recursiveDelete(
                new File("E:\\MQ\\Schubert"),
                new File("F\\The Last Six Years, vol 4-Imogen Cooper")
        );
    }
    ...
    public void clean() throws Exception {
        log.info("EndOfDataChunk:" + Hex.asHex(findEndOfDataChunk()));
    }
     ...
     */
    private int readChunk(FileChannel fc)
