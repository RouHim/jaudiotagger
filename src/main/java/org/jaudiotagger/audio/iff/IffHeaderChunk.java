...
public class IffHeaderChunk {
    ...
    protected static final Logger log = LoggerFactory.getLogger(IffHeaderChunk.class);
    ...
    public static int HEADER_LENGTH =
            SIGNATURE_LENGTH + SIZE_LENGTH + TYPE_LENGTH;
     ...
     */
    public static void ensureOnEqualBoundary(
        ...
        if (Utils.isOddLength(chunkHeader.getSize())) {
            ...
            if (raf.getFilePointer() < raf.length()) {
                log.debug("Skipping Byte because on odd boundary");
                raf.skipBytes(1);
            }
        }
    }
