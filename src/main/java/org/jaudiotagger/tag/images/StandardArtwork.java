...
public class StandardArtwork implements Artwork {
     ...
     */
    public static StandardArtwork createArtworkFromFile(File file)
            throws IOException {
    ...
    public static StandardArtwork createLinkedArtworkFromURL(String url)
            throws IOException {
        StandardArtwork artwork = new StandardArtwork();
     ...
     * @param coverArt
     */
    public void setFromMetadataBlockDataPicture(
            MetadataBlockDataPicture coverArt
    ) {
    ...
    public BufferedImage getImage() throws IOException {
        ImageInputStream iis = ImageIO.createImageInputStream(
                new ByteArrayInputStream(getBinaryData())
        );
