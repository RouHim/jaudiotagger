...
public class DataTypes {
   ...
   *
   */
  public static final String OBJ_ID3V2_FRAME_DESCRIPTION =
    "ID3v2FrameDescription";
  ...
  //SYTC Frame
  public static final String OBJ_SYNCHRONISED_TEMPO_DATA =
    "SynchronisedTempoData";
  public static final String OBJ_SYNCHRONISED_TEMPO = "SynchronisedTempo";
  public static final String OBJ_SYNCHRONISED_TEMPO_LIST =
  ...
  public static final String OBJ_REVERB_FEEDBACK_LEFT_TO_LEFT =
    "ReverbFeedbackLeftToLeft";
  public static final String OBJ_REVERB_FEEDBACK_LEFT_TO_RIGHT =
    "ReverbFeedbackLeftToRight";
  public static final String OBJ_REVERB_FEEDBACK_RIGHT_TO_RIGHT =
    "ReverbFeedbackRightToRight";
  public static final String OBJ_REVERB_FEEDBACK_RIGHT_TO_LEFT =
