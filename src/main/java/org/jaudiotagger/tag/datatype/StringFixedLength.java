...
public class StringFixedLength extends AbstractString {
    ...
    public byte[] writeByteArray() {
        ...
        try {
            ...
            log.warn(
                    "There was a problem writing the following StringFixedlength Field:" +
                            value +
                            ":" +
                            ce.getMessage() +
        ...
        if (dataBuffer != null) {
            ...
            //There is more data available than allowed for this field strip
                ...
                log.warn(
                        "There was a problem writing the following StringFixedlength Field:" +
                                value +
                                " when converted to bytes has length of:" +
                                dataBuffer.limit() +
                                " but field was defined with length of:" +
                                size +
            ...
            log.warn(
                    "There was a serious problem writing the following StringFixedlength Field:" +
                            value +
                            ":" +
                            "using default value instead"
            );
