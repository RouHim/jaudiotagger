...
public abstract class AbstractDataType {
  ...
  public AbstractDataType(AbstractDataType copyObject) {
    ...
    if (copyObject.value == null) {
      ...
      copyObject.value instanceof MultipleTextEncodedStringNullTerminated.Values
    ) {
      this.value = copyObject.value;
    } else if (
      copyObject.value instanceof
  ...
  public boolean equals(Object obj) {
    ...
    if (this.value instanceof boolean[] && object.value instanceof boolean[]) {
      ...
      this.value instanceof double[] && object.value instanceof double[]
    ) {
      return Arrays.equals((double[]) this.value, (double[]) object.value);
      // float[]
    } else if (
      this.value instanceof float[] && object.value instanceof float[]
    ) {
      ...
      this.value instanceof Object[] && object.value instanceof Object[]
    ) {
      return Arrays.equals((Object[]) this.value, (Object[]) object.value);
      // short[]
    } else if (
      this.value instanceof short[] && object.value instanceof short[]
    ) {
