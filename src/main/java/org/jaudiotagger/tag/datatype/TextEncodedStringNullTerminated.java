    ...
    public byte[] writeByteArray() {
        ...
        try {
            if (StandardCharsets.UTF_16.equals(charset)) {
                ...
                CharacterCodingException ce) { //https://bitbucket.org/ijabz/jaudiotagger/issue/1/encoding-metadata-to-utf-16-can-fail-if
            log.error(ce.getMessage() + ":" + charset.name() + ":" + value);
