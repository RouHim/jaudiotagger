...
public class MultipleTextEncodedStringNullTerminated extends AbstractDataType {
   ...
   * @param frameBody
   */
  public MultipleTextEncodedStringNullTerminated(
    String identifier,
  ...
  public MultipleTextEncodedStringNullTerminated(
    MultipleTextEncodedStringNullTerminated object
  ) {
    super(object);
  }
  ...
  public boolean equals(Object obj) {
    return (
      obj instanceof MultipleTextEncodedStringNullTerminated &&
      super.equals(obj)
    );
  }
  ...
  public boolean canBeEncoded() {
    for (
      ListIterator<String> li = ((Values) value).getList().listIterator();
      li.hasNext();
  ...
  public void readByteArray(byte[] arr, int offset)
    ...
    logger.debug(
      "Reading MultipleTextEncodedStringNullTerminated from array from offset:" +
        offset
    );
  ...
  public byte[] writeByteArray() {
    logger.debug("Writing MultipleTextEncodedStringNullTerminated");
    ...
    logger.debug("Written MultipleTextEncodedStringNullTerminated");
