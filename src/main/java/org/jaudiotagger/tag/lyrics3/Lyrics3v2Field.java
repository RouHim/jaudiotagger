...
public class Lyrics3v2Field extends AbstractTagFrame {
   ...
   * @throws InvalidTagException
   */
  private AbstractLyrics3v2FieldFrameBody readBody(
    String identifier,
    ...
    if (identifier.equals(Lyrics3v2Fields.FIELD_V2_AUTHOR)) {
      ...
      identifier.equals(Lyrics3v2Fields.FIELD_V2_ADDITIONAL_MULTI_LINE_TEXT)
    ) {
      newBody = new FieldFrameBodyINF(byteBuffer);
    } else if (
      identifier.equals(Lyrics3v2Fields.FIELD_V2_LYRICS_MULTI_LINE_TEXT)
    ) {
