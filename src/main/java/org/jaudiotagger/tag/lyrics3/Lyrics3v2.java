...
public class Lyrics3v2 extends AbstractLyrics3 {
    ...
    public Lyrics3v2(AbstractTag mp3tag) {
        if (mp3tag != null) {
            ...
            if (mp3tag instanceof Lyrics3v2) {
                ...
                newField = new Lyrics3v2Field(
                        new FieldFrameBodyLYR(lyricOld.getLyric())
                );
    ...
    public void write(RandomAccessFile file) throws IOException {
        ...
        if (this.getSize() != size) {
            //log.debug("Lyrics3v2 size didn't match up while writing.");
            //log.debug("this.getsize()     = " + this.getSize());
            //log.debug("size (filePointer) = " + size);
        }
    ...
    public void updateField(String identifier) {
        ...
        if (identifier.equals("IND")) {
            ...
            lyrField = new Lyrics3v2Field(
                    new FieldFrameBodyIND(lyricsPresent, timeStampPresent)
            );
            setField(lyrField);
        }
    }
