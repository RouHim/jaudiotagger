...
public abstract class AbstractTagFrameBody extends AbstractTagItem {
    ...
    protected AbstractTagFrameBody(AbstractTagFrameBody copyObject) {
        ...
        for (int i = 0; i < copyObject.objectList.size(); i++) {
            newObject = (AbstractDataType) ID3Tags.copyObject(
    ...
    public boolean isSubsetOf(Object obj) {
        ...
        ArrayList<AbstractDataType> superset =
                ((AbstractTagFrameBody) obj).objectList;
    ...
    public boolean equals(Object obj) {
        ...
        boolean check =
                this.objectList.equals(object.objectList) && super.equals(obj);
        return check;
    }
