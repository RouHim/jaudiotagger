...
public class ID3v22Frames extends ID3Frames {
   ...
   */
  protected EnumMap<FieldKey, ID3v22FieldKey> tagFieldToId3 = new EnumMap<
    FieldKey,
    ID3v22FieldKey
  >(FieldKey.class);
   ...
   */
  protected EnumMap<ID3v22FieldKey, FieldKey> id3ToTagField = new EnumMap<
    ID3v22FieldKey,
    FieldKey
  ...
  private ID3v22Frames() {
    ...
    idToValue.put(
      ...
      "Text: Conductor/Performer refinement"
    );
    idToValue.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v22FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v22FieldKey.MUSICBRAINZ_WORK_COMPOSITION
    );
    tagFieldToId3.put(
