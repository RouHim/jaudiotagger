...
public class ID3TextEncodingConversion {
    ...
    protected static final Logger log = LoggerFactory.getLogger(ID3TextEncodingConversion.class);
     ...
     */
    public static byte getTextEncoding(
            AbstractTagFrame header,
            byte textEncoding
    ) {
        ...
        if (header == null) {
            ...
            if (
                    TagOptionSingleton.getInstance().isResetTextEncodingForExistingFrames()
            ) {
