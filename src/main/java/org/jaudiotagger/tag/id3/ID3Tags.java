...
public class ID3Tags {
    ...
    public static boolean isID3v22FrameIdentifier(String identifier) {
        ...
        //If 3 is it a known identifier
            ...
            return (
                    identifier.length() == 3 &&
                            ID3v22Frames.getInstanceOf().getIdToValueMap().containsKey(identifier)
            );
        }
    }
    ...
    public static boolean isID3v23FrameIdentifier(String identifier) {
        return (
                identifier.length() >= 4 &&
                        ID3v23Frames.getInstanceOf()
                                .getIdToValueMap()
                                .containsKey(identifier.substring(0, 4))
        );
    }
    ...
    public static String convertFrameID23To22(String identifier) {
        ...
        if (
                ID3v23Frames.getInstanceOf().getIdToValueMap().containsKey(identifier)
        ) {
    ...
    public static String convertFrameID23To24(String identifier) {
        ...
        if (
            ...
            if (
                    ID3v24Frames.getInstanceOf().getIdToValueMap().containsKey(identifier)
            ) {
                return identifier;
            }
    ...
    public static Object copyObject(Object copyObject) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "NoSuchMethodException: Error finding constructor to create copy:" +
                            copyObject.getClass().getName()
            );
        } catch (IllegalAccessException ex) {
            throw new IllegalArgumentException(
                    "IllegalAccessException: No access to run constructor to create copy" +
                            copyObject.getClass().getName()
            );
        } catch (InstantiationException ex) {
            throw new IllegalArgumentException(
                    "InstantiationException: Unable to instantiate constructor to copy" +
                            copyObject.getClass().getName()
            );
