...
public class FrameBodyTDRC
    ...
    protected static final Logger log = LoggerFactory.getLogger(FrameBodyTDRC.class);
     ...
     * @return
     */
    private static synchronized String formatAndParse(
    ...
    public void findMatchingMaskAndExtractV3Values() {
        ...
        for (int i = 0; i < formatters.size(); i++) {
            ...
            } catch (ParseException e) { //Dont display will occur for each failed format
                //Do nothing;
    ...
    //first day
    private void extractID3v23Formats(
    ...
    public void setYear(String year) {
        log.debug("Setting year to" + year);
        this.year = year;
    }
    ...
    public void setTime(String time) {
        log.debug("Setting time to:" + time);
        this.time = time;
    }
