...
public class FrameBodyCOMR
  ...
  public void write(ByteArrayOutputStream tagBuffer) {
    if (
      !((AbstractString) getObject(DataTypes.OBJ_SELLER_NAME)).canBeEncoded()
    ) {
  ...
  protected void setupObjectList() {
    ...
    objectList.add(
      new TextEncodedStringNullTerminated(DataTypes.OBJ_SELLER_NAME, this)
    );
    objectList.add(
    ...
    objectList.add(
      new ByteArraySizeTerminated(DataTypes.OBJ_SELLER_LOGO, this)
    );
  }
}
