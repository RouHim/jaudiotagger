...
public class FrameBodyUSLT
    ...
    public String getFirstTextValue() {
        TextEncodedStringSizeTerminated text =
                (TextEncodedStringSizeTerminated) getObject(DataTypes.OBJ_LYRICS);
    ...
    public void write(ByteArrayOutputStream tagBuffer) {
        ...
        if (
                !((AbstractString) getObject(DataTypes.OBJ_DESCRIPTION)).canBeEncoded()
        ) {
            this.setTextEncoding(
    ...
    protected void setupObjectList() {
        ...
        objectList.add(
                new TextEncodedStringSizeTerminated(DataTypes.OBJ_LYRICS, this)
        );
    }
}
