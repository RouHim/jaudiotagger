...
public enum ID3v24FieldKey {
    ...
    MUSICBRAINZ_TRACK_ID(
            ID3v24Frames.FRAME_ID_UNIQUE_FILE_ID,
    ...
    URL_OFFICIAL_ARTIST_SITE(
            ID3v24Frames.FRAME_ID_URL_ARTIST_WEB,
            Id3FieldType.TEXT
    ),
    ...
    public static ID3v24FieldKey fromFrameId(String frameId) {
        for (ID3v24FieldKey v : ID3v24FieldKey.values()) {
