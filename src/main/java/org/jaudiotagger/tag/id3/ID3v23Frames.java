...
public class ID3v23Frames extends ID3Frames {
     ...
     */
    protected EnumMap<FieldKey, ID3v23FieldKey> tagFieldToId3 = new EnumMap<
            FieldKey,
            ID3v23FieldKey
            >(FieldKey.class);
     ...
     */
    protected EnumMap<ID3v23FieldKey, FieldKey> id3ToTagField = new EnumMap<
            ID3v23FieldKey,
            FieldKey
    ...
    private ID3v23Frames() {
        ...
        tagFieldToId3.put(
                ...
                ID3v23FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID
        );
        tagFieldToId3.put(
