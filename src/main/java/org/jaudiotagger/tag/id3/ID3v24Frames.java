...
public class ID3v24Frames extends ID3Frames {
  ...
  protected EnumMap<FieldKey, ID3v24FieldKey> tagFieldToId3 = new EnumMap<
    FieldKey,
    ID3v24FieldKey
  >(FieldKey.class);
   ...
   */
  protected EnumMap<ID3v24FieldKey, FieldKey> id3ToTagField = new EnumMap<
    ID3v24FieldKey,
    FieldKey
  ...
  private ID3v24Frames() {
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.ACOUSTID_FINGERPRINT
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.CLASSICAL_CATALOG
    );
    tagFieldToId3.put(
      FieldKey.CLASSICAL_NICKNAME,
      ID3v24FieldKey.CLASSICAL_NICKNAME
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.MOOD_INSTRUMENTAL
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.MOOD_DANCEABILITY
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.MUSICBRAINZ_ARTISTID
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_DISC_ID,
      ID3v24FieldKey.MUSICBRAINZ_DISC_ID
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.MUSICBRAINZ_RELEASEARTISTID
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_RELEASEID,
      ID3v24FieldKey.MUSICBRAINZ_RELEASEID
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_RELEASE_COUNTRY,
      ID3v24FieldKey.MUSICBRAINZ_RELEASE_COUNTRY
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.MUSICBRAINZ_RELEASE_STATUS
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.MUSICBRAINZ_RELEASE_TYPE
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_TRACK_ID,
      ID3v24FieldKey.MUSICBRAINZ_TRACK_ID
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_WORK,
      ID3v24FieldKey.MUSICBRAINZ_WORK
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_WORK_ID,
      ID3v24FieldKey.MUSICBRAINZ_WORK_ID
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_WORK_COMPOSITION,
      ID3v24FieldKey.WORK_COMPOSITION
    );
    tagFieldToId3.put(
      FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID,
      ID3v24FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.ORIGINAL_LYRICIST
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.PERFORMER_NAME_SORT
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.SINGLE_DISC_TRACK_NO
    );
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.WORK_PART_LEVEL2
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.WORK_PART_LEVEL3
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.WORK_PART_LEVEL4
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.WORK_PART_LEVEL5
    );
    tagFieldToId3.put(
    ...
    tagFieldToId3.put(
      ...
      ID3v24FieldKey.WORK_PART_LEVEL6
    );
    tagFieldToId3.put(
