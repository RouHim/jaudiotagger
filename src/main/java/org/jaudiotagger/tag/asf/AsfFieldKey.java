...
public enum AsfFieldKey {
    ...
    RATING(
            ContentDescription.KEY_RATING,
            false,
            ContainerType.CONTENT_DESCRIPTION
    ),
    COPYRIGHT(
            ContentDescription.KEY_COPYRIGHT,
            false,
            ContainerType.CONTENT_DESCRIPTION
    ),
    DESCRIPTION(
            ContentDescription.KEY_DESCRIPTION,
            false,
            ContainerType.CONTENT_DESCRIPTION
    ),
    ...
    BANNER_IMAGE_TYPE(
            ContentBranding.KEY_BANNER_TYPE,
            false,
            ContainerType.CONTENT_BRANDING
    ),
    BANNER_IMAGE_URL(
    ...
    MUSICBRAINZ_WORK_PART_LEVEL2_ID(
            "MUSICBRAINZ_MUSICBRAINZ_WORK_PART_LEVEL2_ID",
            true
    ),
    ...
    MUSICBRAINZ_WORK_PART_LEVEL3_ID(
            "MUSICBRAINZ_MUSICBRAINZ_WORK_PART_LEVEL3_ID",
            true
    ),
    ...
    MUSICBRAINZ_WORK_PART_LEVEL4_ID(
            "MUSICBRAINZ_MUSICBRAINZ_WORK_PART_LEVEL4_ID",
            true
    ),
    ...
    static {
        FIELD_ID_MAP = new HashMap<String, AsfFieldKey>(
                AsfFieldKey.values().length
        );
        for (AsfFieldKey curr : AsfFieldKey.values()) {
            if (curr != CUSTOM) {
                assert !FIELD_ID_MAP.containsKey(
                        curr.getFieldName()
                ) : "duplicate field entry: " + curr.getFieldName();
     ...
     */
    AsfFieldKey(
            final String asfFieldName,
            final boolean multiValue,
            final ContainerType lowest,
            final ContainerType highest
    ) {
