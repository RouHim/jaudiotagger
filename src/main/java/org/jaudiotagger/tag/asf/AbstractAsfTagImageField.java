...
abstract class AbstractAsfTagImageField extends AsfTagField {
     ...
     */
    protected AbstractAsfTagImageField(final AsfFieldKey field) {
        super(field);
    }
     ...
     *               {@link TagField}.
     */
    protected AbstractAsfTagImageField(final MetadataDescriptor source) {
        super(source);
    }
     ...
     */
    protected AbstractAsfTagImageField(final String fieldKey) {
        super(fieldKey);
    }
