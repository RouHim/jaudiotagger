...
public final class AsfTag extends AbstractTag {
    ...
    static {
        ...
        tagFieldToAsfField.put(
                FieldKey.ACOUSTID_FINGERPRINT,
                AsfFieldKey.ACOUSTID_FINGERPRINT
        );
        ...
        tagFieldToAsfField.put(
                ...
                AsfFieldKey.ALBUM_ARTISTS_SORT
        );
        ...
        tagFieldToAsfField.put(
                ...
                AsfFieldKey.CLASSICAL_CATALOG
        );
        tagFieldToAsfField.put(
                FieldKey.CLASSICAL_NICKNAME,
                AsfFieldKey.CLASSICAL_NICKNAME
        );
        ...
        tagFieldToAsfField.put(
                ...
                AsfFieldKey.MUSICBRAINZ_WORK
        );
        tagFieldToAsfField.put(
                FieldKey.MUSICBRAINZ_WORK_ID,
                AsfFieldKey.MUSICBRAINZ_WORKID
        );
        tagFieldToAsfField.put(
                FieldKey.MUSICBRAINZ_WORK_COMPOSITION,
                AsfFieldKey.MUSICBRAINZ_WORK_COMPOSITION
        );
        tagFieldToAsfField.put(
                FieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID,
                AsfFieldKey.MUSICBRAINZ_WORK_COMPOSITION_ID
        );
        tagFieldToAsfField.put(
        ...
        tagFieldToAsfField.put(
                ...
                AsfFieldKey.ORIGINAL_ARTIST
        );
        tagFieldToAsfField.put(
                FieldKey.ORIGINAL_LYRICIST,
                AsfFieldKey.ORIGINAL_LYRICIST
        );
        ...
        tagFieldToAsfField.put(
                ...
                AsfFieldKey.PERFORMER_NAME_SORT
        );
        ...
        tagFieldToAsfField.put(
                ...
                AsfFieldKey.SINGLE_DISC_TRACK_NO
        );
    ...
    public List<Artwork> getArtworkList() {
        ...
        final List<Artwork> artworkList = new ArrayList<Artwork>(
                coverartList.size()
        );
    ...
    public String getValue(final FieldKey genericKey, int index)
        ...
        return super.getItem(
                tagFieldToAsfField.get(genericKey).getFieldName(),
                index
        );
    }
    ...
    public AsfTagField getFirstField(final FieldKey genericKey)
        ...
        return (AsfTagField) super.getFirstField(
                tagFieldToAsfField.get(genericKey).getFieldName()
        );
    }
     ...
     */
    @Override
    public AsfTagTextField createField(
            final FieldKey genericKey,
            final String... values
    ) throws KeyNotFoundException, FieldDataInvalidException {
     ...
     * {@link AsfTagField}.<br>
     *
     * @param fieldIterator source iterator.
     * @author Christian Laireiter
     */
        private record AsfFieldIterator(Iterator<TagField> fieldIterator) implements Iterator<AsfTagField> {

        /**
         * Creates an isntance.
         *
         * @param fieldIterator iterator to read from.
         */
        private AsfFieldIterator {
            assert fieldIterator != null;
        }
