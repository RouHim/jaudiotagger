...
public class VorbisCommentTag extends AbstractTag {
  ...
  > tagFieldToOggField = new EnumMap<>(FieldKey.class);

  static {
    tagFieldToOggField.put(
    ...
    tagFieldToOggField.put(
      FieldKey.ALBUM_ARTISTS,
      VorbisCommentFieldKey.ALBUMARTISTS
    );
    tagFieldToOggField.put(
      FieldKey.ALBUM_ARTISTS_SORT,
    ...
    tagFieldToOggField.put(
      FieldKey.CLASSICAL_CATALOG,
      VorbisCommentFieldKey.CLASSICAL_CATALOG
    );
    tagFieldToOggField.put(
      FieldKey.CLASSICAL_NICKNAME,
    ...
    tagFieldToOggField.put(
      FieldKey.IS_SOUNDTRACK,
      VorbisCommentFieldKey.IS_SOUNDTRACK
    );
    tagFieldToOggField.put(
      FieldKey.ITUNES_GROUPING,
      VorbisCommentFieldKey.ITUNES_GROUPING
    );
    ...
    tagFieldToOggField.put(
      FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1,
    ...
    tagFieldToOggField.put(
      FieldKey.MUSICBRAINZ_WORK_PART_LEVEL2,
    ...
    tagFieldToOggField.put(
      FieldKey.MUSICBRAINZ_WORK_PART_LEVEL3,
    ...
    tagFieldToOggField.put(
      FieldKey.MUSICBRAINZ_WORK_PART_LEVEL4,
    ...
    tagFieldToOggField.put(
      FieldKey.MUSICBRAINZ_WORK_PART_LEVEL5,
    ...
    tagFieldToOggField.put(
      FieldKey.MUSICBRAINZ_WORK_PART_LEVEL6,
    ...
    tagFieldToOggField.put(
      FieldKey.PERFORMER_NAME,
      VorbisCommentFieldKey.PERFORMER_NAME
    );
    tagFieldToOggField.put(
      FieldKey.PERFORMER_NAME_SORT,
  ...
  public TagField createField(
    ...
    return new VorbisCommentTagField(
      vorbisCommentFieldKey.getFieldName(),
      value
    );
  }
  ...
  public List<TagField> getFields(FieldKey genericKey)
    ...
    VorbisCommentFieldKey vorbisCommentFieldKey = tagFieldToOggField.get(
      genericKey
    );
    if (vorbisCommentFieldKey == null) {
      throw new KeyNotFoundException();
   ...
   * @throws org.jaudiotagger.tag.KeyNotFoundException
   */
  public List<TagField> get(VorbisCommentFieldKey vorbisCommentKey)
    throws KeyNotFoundException {
  ...
  public boolean hasField(FieldKey genericKey) {
    ...
    if (vorbisFieldKey == null) return false;
  ...
  public void deleteField(FieldKey genericKey) throws KeyNotFoundException {
    ...
    if (genericKey == FieldKey.ALBUM_ARTIST) {
      switch (
        TagOptionSingleton.getInstance().getVorbisAlbumArtistSaveOptions()
      ) {
  ...
  public List<Artwork> getArtworkList() {
    ...
    //Read Old Format
    if (
      (getArtworkBinaryData() != null) & (getArtworkBinaryData().length > 0)
    ) {
   ...
   */
  private MetadataBlockDataPicture createMetadataBlockDataPicture(
    Artwork artwork
    ...
    if (artwork.isLinked()) {
      ...
      if (!artwork.setImageFromData()) {
        throw new FieldDataInvalidException(
          "Unable to create MetadataBlockDataPicture from buffered"
        );
      }
      return new MetadataBlockDataPicture(
  ...
  public TagField createField(Artwork artwork)
    ...
    try {
      String base64image = Base64.getEncoder().encodeToString(
        createMetadataBlockDataPicture(artwork).getRawContent()
      );
      TagField imageTagField = createField(
        VorbisCommentFieldKey.METADATA_BLOCK_PICTURE,
        base64image
      );
  ...
  public void setArtworkField(byte[] data, String mimeType) {
    ...
    VorbisCommentTagField dataField = new VorbisCommentTagField(
      VorbisCommentFieldKey.COVERART.getFieldName(),
      base64image
    );
    VorbisCommentTagField mimeField = new VorbisCommentTagField(
      VorbisCommentFieldKey.COVERARTMIME.getFieldName(),
      mimeType
    );
   ...
   * @throws FieldDataInvalidException
   */
  public void setField(String vorbisCommentKey, String value)
    throws KeyNotFoundException, FieldDataInvalidException {
   ...
   * @throws FieldDataInvalidException
   */
  public void addField(String vorbisCommentKey, String value)
    throws KeyNotFoundException, FieldDataInvalidException {
    TagField tagfield = createField(vorbisCommentKey, value);
    addField(tagfield);
  }
    ...
    if (genericKey == FieldKey.ALBUM_ARTIST) {
      switch (
        ...
        case WRITE_BOTH: {
          ...
          setField(tagfield1);
          TagField tagfield2 = createField(
            VorbisCommentFieldKey.ALBUMARTIST_JRIVER,
            value
          );
          setField(tagfield2);
   ...
   */
  @Override
  public void addField(FieldKey genericKey, String... values)
    throws KeyNotFoundException, FieldDataInvalidException {
    if (values == null || values[0] == null) {
      throw new IllegalArgumentException(
        ErrorMessage.GENERAL_INVALID_NULL_ARGUMENT.getMsg()
  ...
  public String getValue(FieldKey genericKey, int index)
    ...
    if (genericKey == FieldKey.ALBUM_ARTIST) {
      switch (
        TagOptionSingleton.getInstance().getVorbisAlbumArtisReadOptions()
      ) {
