...
public class TagOptionSingleton {
     ...
     *
     */
    private static final HashMap<String, TagOptionSingleton> tagOptionTable =
            new HashMap<String, TagOptionSingleton>();
    /**
     *
     */
    ...
    private VorbisAlbumArtistSaveOptions vorbisAlbumArtistSaveOptions =
            VorbisAlbumArtistSaveOptions.WRITE_ALBUMARTIST;
    private VorbisAlbumArtistReadOptions vorbisAlbumArtistReadOptions =
            VorbisAlbumArtistReadOptions.READ_ALBUMARTIST_THEN_JRIVER;
    /**
     *
     */
    private HashMap<
            Class<? extends ID3v24FrameBody>,
            LinkedList<String>
    ...
    public void setToDefault() {
        ...
        Iterator<String> iterator = Lyrics3v2Fields.getInstanceOf()
                .getIdToValueMap()
                .keySet()
                .iterator();
        String fieldId;
        ...
        try {
            ...
            iterator = GenreTypes.getInstanceOf()
                    .getValueToIdMap()
                    .keySet()
                    .iterator();
     ...
     * @return
     */
    public Iterator<String> getKeywordListIterator(
            Class<? extends ID3v24FrameBody> id3v2_4FrameBody
    ) {
    ...
    public void addKeyword(
            Class<? extends ID3v24FrameBody> id3v2FrameBodyClass,
            String keyword
    ) throws TagException {
    ...
    public void setVorbisAlbumArtistReadOptions(
     ...
     */
    public void setLyrics3KeepEmptyFieldIfRead(
            boolean lyrics3KeepEmptyFieldIfRead
    ) {
     ...
     */
    public void setOriginalSavedAfterAdjustingID3v2Padding(
            boolean originalSavedAfterAdjustingID3v2Padding
    ) {
        this.originalSavedAfterAdjustingID3v2Padding =
     ...
     */
    public void setRemoveTrailingTerminatorOnWrite(
            boolean removeTrailingTerminatorOnWrite
    ) {
     ...
     */
    public void setResetTextEncodingForExistingFrames(
            boolean resetTextEncodingForExistingFrames
    ) {
        this.resetTextEncodingForExistingFrames =
    ...
    public void setEncodeUTF16BomAsLittleEndian(
            boolean encodeUTF16BomAsLittleEndian
    ) {
    ...
    public void setAPICDescriptionITunesCompatible(
            boolean APICDescriptionITunesCompatible
    ) {
