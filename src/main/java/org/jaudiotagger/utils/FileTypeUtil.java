...
public class FileTypeUtil {
    ...
    protected static final Logger log = LoggerFactory.getLogger(FileTypeUtil.class);
    ...
    static void main(String[] args) throws IOException {
        // if (args.length < 1) {
        // log.info("Usage: java TestExcelPDF <filename>");
        // System.exit(1);
        // }
        String testFileLoc =
        ...
        log.info("File Extension: " + getMagicExt(fileType));
    }
    ...
    public static String getMagicFileType(File f) throws IOException {
        ...
        try {
            ...
            for (
                    Iterator<String> i = signatureMap.keySet().iterator();
                    i.hasNext();
    ...
    private static boolean matchesSignature(
            Integer[] signature,
            byte[] buffer,
            int size
    ) {
